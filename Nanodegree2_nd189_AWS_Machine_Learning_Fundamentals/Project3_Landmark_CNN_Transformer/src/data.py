...
def get_data_loaders(
    ...
    # Image scaling and croping 
    img_scale = 256 
    img_crop = 224 
    
    # Image translation and transformation 
    rotate = 10 
    scale = (0.9, 1.1) 
    translate = (0.1, 0.1) 
    flip = 0.5
    ...
    data_transforms = {
        ...
        "train": transforms.Compose(
            ...
            [
                ...
                transforms.RandomHorizontalFlip(flip), 
                # Finally crop or take a 224x224 random part of the image
                transforms.RandomCrop(img_crop, padding_mode="reflect", pad_if_needed=True),
                # Convert image data to tensor and normalised the data 
                transforms.ToTensor(),
        ...
        "valid": transforms.Compose(
            ...
            [
                # transforms.Resize(img_scale),
                # Finally resize the image to 224x224
    ...
    # # add GPU arguments to make all GPU work 
    # gpu_kwargs = {}
...
def visualize_one_batch(data_loaders, max_n: int = 5):
    ...
    # obtained
    images, labels  = next(dataiter) #next(dataiter) #dataiter.next() # YOUR CODE HERE
    ...
    class_names  = train_loader.dataset.classes #train_loader.dataset.class_to_idx #train_loader.dataset.class_to_idx[labels] #train_loader.dataset.classes #data_loaders.idx[labels] # YOUR CODE HERE
...
def test_data_loaders_output_type(data_loaders):
    ...
    images, labels = next(dataiter) #next(dataiter) #dataiter.next()
